...
#[cfg(feature = "devnet")]
declare_id!("HfHRndGpS82B5HtEnTeA4fpTVdQqnn8ZYjaENt9oDZJY");
#[cfg(not(feature = "devnet"))]
declare_id!("EkAyJTwXawoFGnfFeqpLNS3dM6BA3AX5xqH8ywFmB4a1");

pub mod admin {
    use anchor_lang::prelude::declare_id;
    #[cfg(feature = "devnet")]
    declare_id!("7CNsf1S2EgqGiMCU8rRFcPbaRwEKhbBn1QbZ8VdACMJi");
    #[cfg(not(feature = "devnet"))]
    declare_id!("GBjK9iJWp5ujkts8B4Ju3iBT5z5mijU5wWV7meNahaE8");
}
